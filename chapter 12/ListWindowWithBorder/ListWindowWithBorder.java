...
public class ListWindowWithBorder extends JFrame
{
   ...
   private void buildMonthPanel()
   {
      ...
      // Give the list a black border, one pixel thick.
   ...
   private class ListListener implements ListSelectionListener
   {
	...
	/**
	 * The main method creates an instance of the ListWindowWithBorder
     * class, which causes it to display its window.
	 */
   
   public static void main(String[] args)
   {
      ListWindowWithBorder lw = new ListWindowWithBorder();
   }
}
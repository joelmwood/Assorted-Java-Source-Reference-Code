...
public class MouseEvents extends JApplet
{
   ...
   private String[] text = {"Pressed", "Clicked", "Released",
   ...
   /**
    * The following private inner class handles mouse events.
    * When an event occurs, the text field for that event
    * is given a yellow background.
    */
   ...
   /**
    * The following private inner class handles mouse motion events.
    */

...
/**
 * The TextEditorWindow class is a simple text editor.
 */
...
public class TextEditorWindow extends JFrame
{
   ...
   public TextEditorWindow()
   {
      ...
      // Add the scroll pane to the conent pane.
      add(scrollPane);
   ...
   private class OpenListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         int chooserStatus;  // Status of the file chooser
         
         // Create a JFileChooser object.
         JFileChooser chooser = new JFileChooser();
         
         // Show an open file dialog box and get the
         // user's selection.
	 ...
	 */
      ...
      private boolean openFile(String filename)
      {
         ...
         String inputLine;// A line from the file
         String editorString = ""; // Contents of the editor
   ...
   private class SaveListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         int chooserStatus; // File chooser status
	 ...
	 */
      ...
      {
         boolean success;  // Flag
         String editorString; // Editor contents
   ...
   private class FontListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ...
         editorText.setFont(new Font(fontName, fontStyle,
                                     fontSize));
      }
   }
}